						...
						<Form.Item
							...
							rules={[
								...
								},
								{
									pattern: /^[^£#“”]*$/,
									message:
										"First name must not contain the following characters: £ # “”",
								},
							]}
						>
							<Input
						...
						<Form.Item
							...
							rules={[
								...
								},
								{
									pattern: /^[^£#“”]*$/,
									message:
										"Last name must not contain the following characters: £ # “”",
								},
							]}
						>
							<Input
				...
				<Form.Item
					...
					rules={[
						{ required: true, message: "Gender must not be empty" },
						{
							type: "enum",
							enum: validGenders,
							message: `Gender must be one of the following: ${validGenders.join(", ")}`,
						},
					]}
				>
					<Radio.Group>
